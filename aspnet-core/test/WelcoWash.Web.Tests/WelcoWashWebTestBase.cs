...
{
    public abstract class WelcoWashWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WelcoWashWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WelcoWashWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<WelcoWashDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<WelcoWashDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WelcoWashDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WelcoWashDbContext, Task<T>> func)
        {
            T result;
